...
app.use('/api/mandats-immo',      require('./routes/mandats-immo'));
app.use('/api/offres-immo',       require('./routes/offres-immo'));
app.use('/api/transactions-immo', require('./routes/transactions-immo'));
app.use('/api/commissions-immo',  require('./routes/commissions-immo'));
...
app.use('/api/admin/credits',      require('./routes/admin-credits'));
app.use('/api/admin/produits',     require('./routes/admin-produits'));
app.use('/api/admin/immo-global',  require('./routes/admin-immo-global'));
app.use('/api/admin/paiements',    require('./routes/admin-paiements'));
