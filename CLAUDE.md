    ...
    - **PDF aux standards OHADA** : Refonte complète de la génération PDF (`GET /api/boutiques/:id/documents/:docId/pdf`) :
      ...
      - **Audit & Correction de Cohérence Photo-Produit du Catalogue Standard (`generate-catalog.js` & `catalogues-standards.json`)** :
        ...
        - **Refonte Globale & Épurée de la Page d'Accueil (`frontend-next/src/app/page.tsx`)** :
          ...
          - **Ajustement UX du Hero (Hauteur des encarts & Boutons)** : Les encarts WhatsApp et Taf Taf s'étirent désormais sur toute la hauteur de la grille (`alignItems: 'stretch'`), comblant ainsi l'espace vide en haut et en bas. Le texte "En savoir plus" de l'encart WhatsApp a été converti en un véritable lien cliquable.
