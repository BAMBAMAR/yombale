- **Module de Partage par QR Code & Lien Vitrine avec Validation Instantanée Marchand (16 août 2026)** 📱 :
  ...
  * **Découplage Annuaire Web vs Accès Direct QR Code (`backend/routes/boutiques.js`)** : Les boutiques physiques dont la visibilité dans l'annuaire web public Nopalou est désactivée (`actif = false`) restent 100% accessibles via leur lien direct ou scan de QR Code au comptoir sans aucune erreur 404, permettant aux clients en magasin de consulter le catalogue et passer des demandes de crédit.
