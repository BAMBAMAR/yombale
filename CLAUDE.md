  ...
  - **Informations Légales OHADA & Standards PDF Professionnels** :
    ...
    - **PDF aux standards OHADA** : Refonte complète de la génération PDF (`GET /api/boutiques/:id/documents/:docId/pdf`) :
      ...
      - **Audit & Correction de Cohérence Photo-Produit du Catalogue Standard (`generate-catalog.js` & `catalogues-standards.json`)** :
        ...
        - **Régénération & Remplacement des Visuels Inappropriés** : Remplacement des URLs Unsplash inadéquates (ex: la photo de technicien électricien en casque jaune pour les *Climatiseurs Split/Armoire* remplacée par une vraie unité murale de climatisation HD, la photo de serviettes pour les *Fers à repasser* remplacée par un fer à vapeur sur vêtements, et mise à jour des visuels de couches/produits bébé). Régénération complète de `catalogues-standards.json`. Résultat : **0 incohérence restante** (100% de concordance photo/produit sur les 2 010 articles du catalogue).
