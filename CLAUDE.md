...
- **Intégration de la Fiscalité, des Documents clients, des Fournisseurs et du mode Hors-ligne (POS)** (ajouté 4 août 2026) :
  ...
  - **Édition des Fournisseurs + Affichage responsive** :
    ...
    - **Correction Tableau Achats / Bons de commande** :
      ...
      - **Maintien dans la Boutique après enregistrement des paramètres fiscaux** : Synchronisation permanente du paramètre d'URL `?manage=BOUTIQUE_ID`. Ainsi, les revalidations du serveur (`revalidatePath`) ne réinitialisent plus l'affichage à la liste globale des boutiques.
