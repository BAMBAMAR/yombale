...
- **Intégration de la Fiscalité, des Documents clients, des Fournisseurs et du mode Hors-ligne (POS)** (ajouté 4 août 2026) :
  ...
  - **Édition des Fournisseurs + Affichage responsive** :
    ...
    - **Correction Tableau Achats / Bons de commande** :
      ...
      - **Documents Justificatifs & Pièces Jointes** : Ajout de la colonne `justificatif_url` dans `bons_commande_fournisseur` et `depenses`. Permet d'attacher le lien de la facture/reçu fournisseur à chaque bon de commande d'achat. Lors de la réception du bon, le justificatif et la référence sont automatiquement associés à la dépense comptable générée.
