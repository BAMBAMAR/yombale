...
- **Correction des Boutons Forçant le Paiement Manuel (`AnnoncesClient.tsx`, `BoutiqueClient.tsx`)** :
  ...
  * **Solution** :
    ...
    4. **Server Actions & API Backend (`actions/paiement.ts`, `paiement.js`, `abonnements.js`)** : Détection structurée de `fallback_manuel` et renvoi de la référence de paiement pour une transmission fluide au composant de modale manuelle.
