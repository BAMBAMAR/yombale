  ...
  printWindow.document.write(`
    ...
    <body>
      <div class="header">
        ...
        <button class="no-print" onclick="window.print()" style="padding:10px 18px; background:#1e3a5f; color:#fff; border:none; border-radius:8px; font-weight:bold; cursor:pointer;">Imprimer / Sauvegarder PDF</button>
      </div>
  ...
  printWindow.document.write(`
    ...
    <body>
      <div class="header">
        ...
        <button class="no-print" onclick="window.print()" style="padding:8px 16px; background:#0284c7; color:#fff; border:none; border-radius:8px; font-weight:bold; cursor:pointer;">Imprimer Fiche</button>
      </div>
