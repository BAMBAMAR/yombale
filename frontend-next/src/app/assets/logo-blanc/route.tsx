    ...
    (
      <div style={{
        ...
        <svg width="340" height="340" viewBox="0 0 512 512" style={{ display: 'block', marginBottom: 36 }}>
          <defs>
            <linearGradient id="nopalouGradMark" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <rect x="26" y="26" width="460" height="460" rx="118" fill="url(#nopalouGradMark)"/>
          <path fillRule="evenodd" d="M120 108h272v296H120Z M324 108H188l136 198Z M188 404h136L188 206Z" fill="#FFFFFF"/>
        </svg>

        <span style={{
          fontSize: 96, fontWeight: 900, color: '#1C2B4A', letterSpacing: -2, display: 'flex', alignItems: 'center',
        }}>
          Nopa<span style={{ color: '#C75B00' }}>lou</span>
        </span>
        <span style={{ fontSize: 28, color: '#64748B', marginTop: 14, fontWeight: 700, display: 'flex' }}>
          nopalou.com
        </span>
      </div>
    ),
