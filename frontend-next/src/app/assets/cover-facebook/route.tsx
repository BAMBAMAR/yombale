    ...
    (
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 24, marginBottom: 32 }}>
          <svg width="90" height="90" viewBox="0 0 512 512" style={{ display: 'block' }}>
            <defs>
              <linearGradient id="coverFbGrad" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <rect x="26" y="26" width="460" height="460" rx="118" fill="url(#coverFbGrad)"/>
            <path fillRule="evenodd" d="M120 108h272v296H120Z M324 108H188l136 198Z M188 404h136L188 206Z" fill="#FFFFFF"/>
          </svg>
          <span style={{ fontSize: 72, fontWeight: 900, color: '#fff', letterSpacing: -2, display: 'flex' }}>
