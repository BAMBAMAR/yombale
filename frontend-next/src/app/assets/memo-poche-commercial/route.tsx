    ...
    (
      <div style={{
        ...
        <div style={{
          ...
          borderBottom: '3px solid #C75B00', paddingBottom: 16, marginBottom: 20,
        }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 16 }}>
          ...
          {[
            ...
            <div key={idx} style={{
              ...
              <span style={{ fontSize: 13, fontWeight: 800, color: '#DC2626' }}>{item.obj}</span>
              <span style={{ fontSize: 12, color: '#16A34A', fontWeight: 700, marginTop: 2 }}>➔ {item.rep}</span>
            </div>
          ))}
        </div>
        ...
        <div style={{
          ...
          <span style={{ fontSize: 12, color: '#E2E8F0', lineHeight: 1.45 }}>
            ...
            4. Faire une fausse vente sur la Caisse POS devant lui.<br />
            5. Enregistrer le QR code de sa vitrine sur son téléphone.
          </span>
        </div>

        {/* Footer Tarifs & Support */}
        <div style={{
          marginTop: 'auto', borderTop: '2px solid #E2E8F0', paddingTop: 12,
