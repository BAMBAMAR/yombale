    ...
    <div className="page-container" style={{ paddingTop: '20px' }}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 36 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 13, color: 'var(--text2)', marginTop: 2 }}>
              Découvrez la plateforme tout-en-un au Sénégal : Comparateur, Caisse POS, Bot WhatsApp &amp; Programme Apporteur.
            </div>
          </div>
        </div>

        {/* ───────────────────────────────────────────────────────────── */}
        {/* HERO DE PRESENTATION (CHARTE NOPALOU)                          */}
        {/* ───────────────────────────────────────────────────────────── */}
        <section style={{
        ...
        <section style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
          <div>
            <span style={{ background: '#EFF6FF', color: '#2563EB', border: '1px solid #BFDBFE', padding: '4px 12px', borderRadius: 20, fontSize: 12, fontWeight: 800 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: 16 }}>
            {/* Card 1 */}
            <div style={{
              background: 'var(--card)', padding: 20, borderRadius: 12, border: '1px solid var(--border)',
              boxShadow: 'var(--shadow)', display: 'flex', flexDirection: 'column', gap: 10
            }}>
              <div style={{ width: 44, height: 44, borderRadius: 10, background: '#FFF7ED', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24 }}>🔍</div>
              <h3 style={{ fontSize: 16, fontWeight: 800, color: 'var(--navy)', margin: 0 }}>1. Super-Comparateur de Prix</h3>
            ...
            <div style={{
              ...
              <div style={{ width: 44, height: 44, borderRadius: 10, background: '#CCFBF1', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24 }}>🏬</div>
              <h3 style={{ fontSize: 16, fontWeight: 800, color: 'var(--navy)', margin: 0 }}>2. Caisse Enregistreuse POS Tactile</h3>
              <p style={{ fontSize: 13, color: 'var(--text2)', margin: 0, lineHeight: 1.5 }}>
            ...
            <div style={{
              ...
              <div style={{ width: 44, height: 44, borderRadius: 10, background: '#FEF3C7', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24 }}>📝</div>
              <h3 style={{ fontSize: 16, fontWeight: 800, color: 'var(--navy)', margin: 0 }}>3. Carnet de Crédits &amp; Dettes Client</h3>
              <p style={{ fontSize: 13, color: 'var(--text2)', margin: 0, lineHeight: 1.5 }}>
            ...
            <div style={{
              ...
              <div style={{ width: 44, height: 44, borderRadius: 10, background: '#D1FAE5', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24 }}>🤖</div>
              <h3 style={{ fontSize: 16, fontWeight: 800, color: 'var(--navy)', margin: 0 }}>4. Assistant Bot Commercial WhatsApp</h3>
              <p style={{ fontSize: 13, color: 'var(--text2)', margin: 0, lineHeight: 1.5 }}>
            ...
            <div style={{
              ...
              <div style={{ width: 44, height: 44, borderRadius: 10, background: '#F3E8FF', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24 }}>💼</div>
              <h3 style={{ fontSize: 16, fontWeight: 800, color: 'var(--navy)', margin: 0 }}>5. Programme Apporteur 10% Récurrent</h3>
              <p style={{ fontSize: 13, color: 'var(--text2)', margin: 0, lineHeight: 1.5 }}>
            ...
            <div style={{
              ...
              <div style={{ width: 44, height: 44, borderRadius: 10, background: '#E0F2FE', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24 }}>🎨</div>
              <h3 style={{ fontSize: 16, fontWeight: 800, color: 'var(--navy)', margin: 0 }}>6. Générateur de Visuels &amp; Flyers</h3>
              <p style={{ fontSize: 13, color: 'var(--text2)', margin: 0, lineHeight: 1.5 }}>
        ...
        <section style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div>
            <h2 style={{ fontSize: 'clamp(20px, 3vw, 28px)', fontWeight: 900, color: 'var(--navy)', margin: '0 0 4px 0' }}>
          ...
          <div style={{ overflowX: 'auto', borderRadius: 12, border: '1px solid var(--border)', background: 'var(--card)', boxShadow: 'var(--shadow)' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: 13, minWidth: 650 }}>
              <thead>
                <tr style={{ background: 'var(--bg)', borderBottom: '1px solid var(--border)', textTransform: 'uppercase', fontSize: 11, color: 'var(--text2)' }}>
                  <th style={{ padding: '14px' }}>Fonctionnalité / Solution</th>
                  <th style={{ padding: '14px', background: '#FFF7ED', color: 'var(--accent)', fontWeight: 800, textAlign: 'center' }}>
                    🚀 Nopalou Tout-en-Un
                  </th>
                  <th style={{ padding: '14px', textAlign: 'center' }}>E-Commerce Classique</th>
                  <th style={{ padding: '14px', textAlign: 'center' }}>Cahier Papier / Dettes</th>
                  <th style={{ padding: '14px', textAlign: 'center' }}>WhatsApp Manuel</th>
                </tr>
              </thead>
              <tbody style={{ color: 'var(--text1)' }}>
                <tr style={{ borderBottom: '1px solid var(--border)' }}>
                  <td style={{ padding: '12px 14px', fontWeight: 700, color: 'var(--navy)' }}>🔍 Comparateur de prix multi-marchands</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', background: '#FFF7ED', color: '#059669', fontWeight: 800 }}>✅ Oui (Produits, Immo, Telecom)</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', color: '#DC2626' }}>❌ Vendeurs isolés</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', color: 'var(--text3)' }}>— Non concerné</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', color: '#DC2626' }}>❌ Aucun comparateur</td>
                </tr>
                <tr style={{ borderBottom: '1px solid var(--border)' }}>
                  <td style={{ padding: '12px 14px', fontWeight: 700, color: 'var(--navy)' }}>🏪 Caisse POS &amp; Carnet Crédits/Dettes</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', background: '#FFF7ED', color: '#059669', fontWeight: 800 }}>✅ Intégré + Relance WhatsApp 1-clic</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', color: '#DC2626' }}>❌ Pas de Caisse magasin</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', color: '#D97706' }}>⚠️ Cahier à risque d&apos;oubli</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', color: '#DC2626' }}>❌ Saisie manuelle pénible</td>
                </tr>
                <tr style={{ borderBottom: '1px solid var(--border)' }}>
                  <td style={{ padding: '12px 14px', fontWeight: 700, color: 'var(--navy)' }}>🤖 Assistant Bot WhatsApp Commercial 24/7</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', background: '#FFF7ED', color: '#059669', fontWeight: 800 }}>✅ Commandes &amp; Réponses auto</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', color: '#DC2626' }}>❌ Pas d&apos;Assistant IA</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', color: '#DC2626' }}>❌ Aucun</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', color: '#D97706' }}>⚠️ Réponses lentes</td>
                </tr>
                <tr style={{ borderBottom: '1px solid var(--border)' }}>
                  <td style={{ padding: '12px 14px', fontWeight: 700, color: 'var(--navy)' }}>💼 Commission Récurrente Apporteur (10%)</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', background: '#FFF7ED', color: '#059669', fontWeight: 800 }}>✅ Revenu passif mensuel à vie</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', color: '#DC2626' }}>❌ Inexistant</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', color: 'var(--text3)' }}>— Aucun</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', color: 'var(--text3)' }}>— Aucun</td>
                </tr>
                <tr>
                  <td style={{ padding: '12px 14px', fontWeight 700, color: 'var(--navy)' }}>💳 Paiements Wave &amp; Orange Money</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', background: '#FFF7ED', color: '#059669', fontWeight: 800 }}>✅ Natif &amp; Instantané</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', color: '#D97706' }}>⚠️ Variable</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', color: '#DC2626' }}>❌ Espèces uniquement</td>
                  <td style={{ padding: '12px 14px', textAlign: 'center', color: '#D97706' }}>⚠️ Envoi de capture manuel</td>
                </tr>
              </tbody>
            </table>
          </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                      ...
                      <div style={{ background: '#020617', padding: 16, borderRadius: 12, border: '1px solid #1E293B', display: 'flex', flexDirection: 'column', gap: 12 }}>
                        <div style={{ display: 'flex', gap: 8 }}>
                          ...
                          <button style={{ background: 'var(--accent)', color: '#FFF', border: 'none', padding: '8px 16px', borderRadius: 8, fontWeight: 700, fontSize: 13 }}>Rechercher</button>
                        </div>
                      ...
                      <div style={{ background: '#020617', padding: 16, borderRadius: 14, border: '1px solid #1E293B', display: 'flex', flexDirection: 'column', gap: 12 }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12 }}>
                          ...
                          <div style={{ background: '#0F172A', padding: 12, borderRadius: 10, border: '1px solid #1E293B', display: 'flex', flexDirection: 'column', gap: 8 }}>
                            <span style={{ fontSize: 10, fontWeight: 700, color: '#94A3B8', textTransform: 'uppercase' }}>MODE D&apos;ENCAISSEMENT</span>
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6 }}>
                              <button style={{ background: '#0284C7', color: '#FFF', border: 'none', padding: 8, borderRadius: 6, fontWeight: 700, fontSize: 10, cursor: 'pointer' }}>🌊 Wave Direct</button>
                              <button style={{ background: '#EA580C', color: '#FFF', border: 'none', padding: 8, borderRadius: 6, fontWeight: 700, fontSize: 10, cursor: 'pointer' }}>🟧 Orange Money</button>
                              <button style={{ background: '#059669', color: '#FFF', border: 'none', padding: 8, borderRadius: 6, fontWeight: 700, fontSize: 10, cursor: 'pointer' }}>💵 Espèces</button>
                              <button onClick={() => setActiveStep(2)} style={{ background: '#D97706', color: '#FFF', border: 'none', padding: 8, borderRadius: 6, fontWeight: 700, fontSize: 10, cursor: 'pointer' }}>📝 Pris à Crédit →</button>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  {activeStep === 3 && (
                    <div style={{ textAlign: 'center', padding: 20, background: '#020617', borderRadius: 14, border: '1px solid #1E293B', maxWidth: 420, margin: '0 auto', width: '100%', display: 'flex', flexDirection: 'column', gap: 12 }}>
                      ...
                      <div style={{ display: 'flex', gap: 8, justifyContent: 'center' }}>
                        <button style={{ background: '#0284C7', color: '#FFF', border: 'none', padding: '8px 14px', borderRadius: 6, fontWeight: 700, fontSize: 11, cursor: 'pointer' }}>🌊 Retirer Wave</button>
                        <button style={{ background: '#EA580C', color: '#FFF', border: 'none', padding: '8px 14px', borderRadius: 6, fontWeight: 700, fontSize: 11, cursor: 'pointer' }}>🟧 Retirer Orange Money</button>
                      </div>
                    </div>
                  )}
                </div>
