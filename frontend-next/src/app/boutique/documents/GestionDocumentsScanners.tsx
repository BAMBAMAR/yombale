...
interface GestionDocumentsScannersProps {
  modalScannerEan: boolean
  scannerEanStatus: string
  scanContinu: boolean
  setScanContinu: (v: boolean) => void
  onArreterScannerEan: () => void

  modalScannerNom: boolean
  statusScannerNom: string
  ocrLoading: boolean
  imageFligeeDocNom: string | null
  videoNomRef: React.RefObject<HTMLVideoElement | null>
  onCapturerNomOCR: () => void
  onArreterScannerNom: () => void

  t: (key: string) => string
}

export default function GestionDocumentsScanners({
  modalScannerEan,
  scannerEanStatus,
  scanContinu,
  setScanContinu,
