              ...
              >
                {prodsFiltres.map(p => {
                  ...
                  return (
                    ...
                    >
                      <p style={{ margin: '0 0 4px', fontSize: 12, fontWeight: 800, color: 'var(--navy, #1C2B4A)', lineHeight: 1.3 }}>{p.nom}</p>
                      ...
                      {qte === 0 ? (
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: '#fff', borderRadius: 6, border: '1px solid #fecaca', padding: 2 }}>
                          <button
                            ...
                            style={{ border: 'none', background: '#fee2e2', color: '#dc2626', width: 28, height: 28, borderRadius: 4, fontWeight: 900, cursor: 'pointer' }}
                          >
                            -
                          </button>
                          ...
                          <button
                            ...
                            style={{ border: 'none', background: '#ef4444', color: '#fff', width: 28, height: 28, borderRadius: 4, fontWeight: 900, cursor: 'pointer' }}
                          >
                            +
                          </button>
                        </div>
