...
export default function PaiementSponsoringBoutiqueClient({ boutiqueId, nomCourt, settings, userId }: Props) {
  ...
  return (
    <div className="paiement-card">
      <div className="paiement-annonce-info">
        <span className="paiement-label">Boutique à sponsoriser</span>
