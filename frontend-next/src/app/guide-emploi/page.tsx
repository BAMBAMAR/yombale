...
const ACHETEUR_STEPS = [
  ...
  {
    icon: Scale, couleur: '#0891b2',
    titre: '2. Comparer côte à côte',
    texte: 'Utilisez le comparateur sur les fiches produits pour comparer leurs caractéristiques et prix chez différents marchands.',
    ctas: [{ label: 'Guide d\'achat →', href: '/guide-achat', couleur: '#0891b2', bg: '#ecfeff' }],
  },
  {
    icon: MessageCircle, couleur: '#25D366',
  ...
  {
    icon: Truck, couleur: '#059669',
    titre: '4. Modes de livraison & Suivi',
    texte: 'Recevez votre colis chez vous. Suivez vos commandes en entrant votre référence (ex : CMD-2026-XXXX) sur la page de suivi ou par WhatsApp.',
    ctas: [{ label: 'Suivre ma commande →', href: '/suivi-commande', couleur: '#059669', bg: '#ecfdf5' }],
  },
  {
    icon: Bell, couleur: '#f59e0b',
            ...
            {ACHETEUR_STEPS.map((step, i) => {
              ...
              return (
                <div key={i} style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
                  <div style={{ background: step.couleur + '12', color: step.couleur, borderRadius: 10, width: 36, height: 36, display: 'flex', alignItems: 'center', flexShrink: 0, justifyContent: 'center' }}>
                    <IconComp size={18} />
                  </div>
                  <div style={{ flex: 1 }}>
