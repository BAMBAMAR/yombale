...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'Programme Partenaires & Apporteurs d\'Affaires | Nopalou',
    description: 'Touchez 20% de commission récurrente chaque mois en recommandant Nopalou.',
  },
}

const JSON_LD_PARTENAIRES = {
  '@context': 'https://schema.org',
  '@type': 'WebPage',
  name: 'Programme Partenaires & Apporteurs d\'Affaires Nopalou',
  url: `${BASE}/partenaires`,
  description: 'Générez des revenus passifs en recommandant Nopalou aux commerçants et agences au Sénégal.',
  publisher: {
    '@type': 'Organization',
    name: 'Nopalou',
    url: BASE,
        ...
        <section style={{
          ...
          <div style={{ maxWidth: 900, margin: '0 auto', position: 'relative', zIndex: 2 }}>
            <span style={{
              ...
              <Handshake size={14} style={{ color: '#ddd6fe' }} />
              <span>PROGRAMME APPORTEURS D&apos;AFFAIRES</span>
            </span>
            ...
            <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
              <Link href="/compte/apporteur" style={{
                ...
                <span>Devenir Apporteur d&apos;Affaires</span>
                <ArrowRight size={16} />
              </Link>
            </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 24 }}>
            ...
            <div style={{ background: '#ffffff', padding: 32, borderRadius: 24, border: '1px solid #e2e8f0', boxShadow: '0 10px 30px rgba(0,0,0,0.05)' }}>
              <div style={{ marginBottom: 16 }}>
                <TrendingUp size={28} style={{ color: 'var(--accent, #C75B00)' }} />
              </div>
            ...
            <div style={{ background: '#ffffff', padding: 32, borderRadius: 24, border: '1px solid #e2e8f0', boxShadow: '0 10px 30px rgba(0,0,0,0.05)' }}>
              <div style={{ marginBottom: 16 }}>
                <Palette size={28} style={{ color: 'var(--accent, #C75B00)' }} />
              </div>
